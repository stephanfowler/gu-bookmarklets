function doSticky() {
	...
	if (winWidth >= 1300) {
		sections = Array.prototype.slice.call(document.querySelectorAll('section:not(.fc-container--thrasher)')).filter(function(section) {
...
if (!window.doneSticky) {
	window.doneSticky = doSticky();
}
